...
countsIn = opt$counts
coldataIn = opt$coldat
mnCountCut = opt$mnCountCut
treeCut = opt$treeCut
doOutliers = opt$callOutliers
outPrefix = opt$o
...
print("Getting variance stabilized counts...")
...
datTraits=coldata
save(datExpr, datTraits, file=paste(outPrefix, 'wgcna_input.Rdata', sep='_'))
